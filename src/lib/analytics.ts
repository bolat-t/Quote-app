...
export type AnalyticsEvent =
    ...
    | 'onboarding_notification_prompt_shown'
    | 'onboarding_notification_accepted'
    | 'onboarding_notification_declined'
    | 'onboarding_journal_taste_saved'
    | 'onboarding_journal_taste_skipped'
    | 'onboarding_signature_signed'
